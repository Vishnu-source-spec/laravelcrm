                ...
                <ul class="pc-navbar">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Invoice</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link"
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Maps</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                    ...
                    <li class="pc-item pc-hasmenu">
                        <a href="#!" class="pc-link">
                            ...
                            <span class="pc-mtext">Maintenance</span><span class="pc-arrow"><i
                                    data-feather="chevron-right"></i></span></a>
                        <ul class="pc-submenu">
                            <li class="pc-item"><a class="pc-link" target="_blank"
                    ...
                    <li class="pc-item"><a href="../pages/contact-us.html" class="pc-link" target="_blank">
                            <span class="pc-micon">
                                <svg class="pc-icon">
                                    <use xlink:href="#custom-24-support"></use>
                                </svg>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <span>It takes continuous effort to maintain high customer satisfaction levels.Internal and
                                external quality measures are often
                        ...
                        <div class="latest-scroll" style="height: 400px; position: relative">
                            <div class="card-body">
                                <div class="row align-items-center m-b-30">
                                    ...
                                    <div class="col">
                                        <a href="#!">
                                            <h6>You have 3 pending tasks. <span class="text-muted float-end f-13">Just
                                                    Now</span></h6>
                                        </a>
                                    </div>
                                </div>
                                <div class="row align-items-center m-b-30">
                                    <div class="col-auto p-r-0">
                                        <i
                                            class="feather icon-shopping-cart bg-light-danger feed-icon text-danger"></i>
                                    </div>
                                    <div class="col">
                                        <a href="#!">
                                            <h6>New order received <span class="text-muted float-end f-13">Just
                                                    Now</span></h6>
                                        </a>
                                    </div>
                                </div>
                                ...
                                <div class="row align-items-center m-b-30">
                                    <div class="col-auto p-r-0">
                                        <i
                                            class="feather icon-shopping-cart bg-light-warning feed-icon text-warning"></i>
                                    </div>
                                    <div class="col">
                                        <a href="#!">
                                            <h6>New order received <span class="text-muted float-end f-13">Just
                            ...
                            <div class="row">
                                ...
                                <div class="col-8">
                                    <div class="p-t-25 p-b-25">
                                        ...
                                        <p class="text-muted m-0">Tickets <span
                                                class="text-primary f-w-400">Answered</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
