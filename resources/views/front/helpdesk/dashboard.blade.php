...
{{-- @section('content')
                        ...
                        <div class="latest-scroll" style="height: 400px; position: relative">
                            <div class="card-body">
                                ...
                                <div class="row align-items-center m-b-30">
                                    ...
                                    <div class="col">
                                        <a href="#!">
                                            <h6>New order received <span class="text-muted float-end f-13">Just Now</span>
                                            </h6>
                                        </a>
                                    </div>
                                </div>
    ...
    <div>
        <h1>Dashboard heloo</h1>
        <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eligendi quas suscipit, pariatur vitae eos consequatur impedit a exercitationem accusantium odio sunt ad, doloremque veritatis quae. Sed similique fuga saepe ipsa?</p>
